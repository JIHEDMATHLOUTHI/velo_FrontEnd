...
export class CollocationServiceService {
  ...
  public getProductById(pid:number){
    return this.httpClient.get<Collocation>("http://localhost:8081/api/collocation/"+pid)
  }
  ...
  public deleteProduct(id:number){
   return this.httpClient.delete("http://localhost:8081/api/collocation"+"/delete/"+id);
    }
