...
export class ProductService {
  ...
  public deleteProduct(id:number){
   return this.httpClient.delete("http://localhost:8081/api"+"/delete/"+id);
    }
    ...
    public addToCart(productId:any){
      ...
      return this.httpClient.get("http://localhost:8081/api/addToCart/"+productId, { headers });
     }
     ...
     public getCartDetails():Observable<CartDetail[]>{
      ...
      return this.httpClient.get<CartDetail[]>("http://localhost:8081/api/getCartDetails", { headers });
     }
     ...
     public getProductDetails(isSingeProductCheckout:any,productId:any){
      ...
      return this.httpClient.get<Product[]>("http://localhost:8081/api/getProductDetails/"+isSingeProductCheckout+"/"+productId, { headers });
     }
     ///////////////
     public getProductDetails2(isSingeProductCheckout:any,productId:any){
      ...
      return this.httpClient.get<Product[]>("http://localhost:8081/api/getProductDetails2/"+isSingeProductCheckout+"/"+productId, { headers });
     }
     ...
     public placeOrder(orderDetails: OrderDetails, isCartCheckout:any){
      ...
      return this.httpClient.post("http://localhost:8081/api/placeOrder/"+isCartCheckout, orderDetails, { headers });
     }
     public getAllOrderDetailsForAdmin() : Observable<MyOrderDetails[]>{
      ...
      return this.httpClient.get<MyOrderDetails[]>("http://localhost:8081/api/getAllOrderDetails", { headers });
     }
    ...
    public getMyOrders() : Observable<MyOrderDetails[]>{
      ...
      return this.httpClient.get<MyOrderDetails[]>("http://localhost:8081/api/getOrderDetails", { headers });
     }
    ...
    public deleteCartItem(cartId:any){
      ...
      return this.httpClient.delete("http://localhost:8081/api/deleteCartItem/"+cartId, { headers });
     }
     triggerScheduledMarkOrdersAsDelivered(): void {
      ...
      this.httpClient.post<any>("http://localhost:8081/api/api/triggerScheduledTask", {},{ headers }).subscribe(
        (resp) => {
     ...
     markOrderAsDelivered(orderId: any): Observable<any> {
      ...
      return this.httpClient.get("http://localhost:8081/api/markOrderAsDelivered/" + orderId, { headers })
        .pipe(
          tap(() => {
    ...
    getMostPurchasedCategory(): Observable<string[]> {
      return this.httpClient.get<string[]>("http://localhost:8081/api/statistics/most-purchased-category");
    }
    ...
    saveProductRating(productId: number, productRating: ProductRating): Observable<ProductRating> {
      ...
      return this.httpClient.post<ProductRating>("http://localhost:8081/api/api/product-ratings/"+productId, productRating, { headers });
    }
    
    getProductRatingByProductId(productId: number): Observable<ProductComment[]> {
      return this.httpClient.get<ProductComment[]>("http://localhost:8081/api/api/product-ratings/product/"+productId);
    }

    statistiqueRating():Observable<string[]>{
      return this.httpClient.get<string[]>("http://localhost:8081/api/api/product-ratings/statistiqueRating");
    }
    ...
    deleteProductFromCart(productId: number): Observable<any> {
      ...
      return this.httpClient.delete("http://localhost:8081/api/product/"+productId, { headers });
    }
    ...
    removeProductFromCart(productId: number): Observable<any> {
      ...
      return this.httpClient.get<any>("http://localhost:8081/api/api/removeProductFromCart/"+productId, { headers })
    }
    ...
    rateProduct(productId: number, rating: number): Observable<ProductRating> {
      ...
      return this.httpClient.post<ProductRating>(`http://localhost:8081/api/api/product-ratings/rate/${productId}/${rating}`, null, { headers });
    }
    ...
    commentProduct(productId: number, comment: string): Observable<ProductComment> {
      ...
      return this.httpClient.post<ProductComment>(`http://localhost:8081/api/api/product-ratings/comment/${productId}/${comment}`, null ,{ headers } );
    }
